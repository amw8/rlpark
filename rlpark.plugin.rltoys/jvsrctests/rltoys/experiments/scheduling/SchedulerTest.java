...
public class SchedulerTest {
  ...
  public void testJobScheduler() {
    ...
    SchedulerTestsUtils.testScheduler(scheduler, 10000);
    scheduler.dispose();
  }
  ...
  public void testServerSchedulerWithUniqueClient() throws IOException {
    ...
    client01.start();
    SchedulerTestsUtils.testServerScheduler(scheduler, 100);
    client01.dispose();
    scheduler.dispose();
  }
  ...
  public void testServerSchedulerWithUniqueClientMultipleThreads() throws IOException {
    ...
    client01.start();
    SchedulerTestsUtils.testServerScheduler(scheduler, 200);
    scheduler.dispose();
    client01.dispose();
  }
