...
public abstract class AbstractOffPolicyRLSweepTest extends RLSweepTest {
  ...
  protected void checkBehaviourPerformanceValue(String filename, String label, double value, double adjustedValue) {
    double minAdjustedValue = 0.2;
    double maxAdjustedValue = 0.8;
    Assert.assertTrue(adjustedValue < maxAdjustedValue && adjustedValue > minAdjustedValue);
