...
public class VideoPlayer implements Runnable, ImageProvider {
  ...
  public void run() {
    ...
    while (container.readNextPacket(packet) >= 0 && clock.tick()) {
      /*
      ...
      if (packet.getStreamIndex() == videoStreamId) {
        ...
        if (picture.isComplete()) {
          ...
          displayedImage = imageConverter.toImage(newPic);
        }
