...
package rlpark.plugin.xuggler.tutorials;
...
public class DecodeAndPlayAudioAndVideo {
  ...
  /**
   * Takes a media container (file) as the first argument, opens it, plays audio
   * as quickly as it can, and opens up a Swing window and displays video frames
   * with <i>roughly</i> the right timing.
   * 
   * @param args
